# CurseForge upload sheet: The Vault Render Optimization 0.3.3
...
| Field | Value |
| --- | --- |
| Upload file | `vault_render_optimization.0.3.3.jar` |
| Display name | `The Vault Render Optimization 0.3.3` |
| Release type | `Release` |
| Game version | `Minecraft 1.18.2` |
| Mod loader | `Forge` |
| Environment | `Client` |
| Changelog format | `Markdown` |
| Changelog | `CHANGELOG-0.3.3.md` |
...
SHA-256: 75CD249A670161521C9A5B5BE2A453B2C1063B845C397C5DF139FFBD64296FFC
Source state: tag the reviewed release commit as `v0.3.3`
```
...
- The crash-fixed JAR has been tested in the affected VaultCrafters client.
