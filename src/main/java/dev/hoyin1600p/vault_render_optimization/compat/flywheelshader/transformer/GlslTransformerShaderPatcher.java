package dev.hoyin1600p.vault_render_optimization.compat.flywheelshader.transformer;
        ...
        transformer = new SingleASTTransformer<>() {
            ...
            public TranslationUnit parseTranslationUnit(Root rootInstance, String input) {
                ...
                if (versionNum < 330) {
                    ...
                    VroFlywheelShaderCompat.LOGGER.warn("GLSL version is lower than 330, set to 330");
                }
